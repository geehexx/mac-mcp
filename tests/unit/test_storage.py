...
class TestInMemoryEventStore:
    ...
    async def test_append_event(self) -> None:
        ...
        event = Event(
            ...
            sequence=1,
            task_id="task1",
            payload={"description": "Test task", "required_capabilities": ["python"]},
        )
    ...
    async def test_read_events(self) -> None:
        ...
        events = [
            ...
            Event(type=EventType.TASK_ASSIGNED, sequence=2, task_id="task1"),
            Event(type=EventType.TASK_COMPLETED, sequence=3, task_id="task1"),
        ]
